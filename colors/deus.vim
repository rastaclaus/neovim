...
let s:ds.dark4       = ['#7c6f64', 241]     " 124-111-100
let s:ds.dark4_256   = ['#7c6f64', 241]     " 124-111-100
...
" Correct background (see isue #7):
" --- Problem with changingbetween dark and light on 256 color terminal
" --- https://github.com/mohetz/deus/issues/7
if s:is_dark
  set background=dark
else
